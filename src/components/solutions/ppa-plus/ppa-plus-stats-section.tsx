...
export function PpaPlusStatsSection() {
  const reduceMotion = useReducedMotion() === true;
  const { headingLines, cards, partner, cta } = solutionsPpaPlusStats;

  return (
    <section
      className="bg-white font-sans"
      aria-labelledby="ppa-plus-stats-heading"
    >
          ...
          >
            <div className="flex w-full flex-col items-center gap-6 sm:flex-row sm:items-start sm:justify-center sm:gap-[9px] sm:pl-8">
              <div className="relative size-[190px] shrink-0">
                <Image
                  src={solutionsPpaPlusAssets.stats.awsBadge}
